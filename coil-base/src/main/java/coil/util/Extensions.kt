...
/** Wrap a [Call.Factory] factory to make sure it's only called once. */
internal fun lazyCallFactory(factory: () -> Call.Factory): Call.Factory {
    val lazy: Lazy<Call.Factory> = lazy(factory)
