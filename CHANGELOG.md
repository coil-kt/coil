...
- **Important**: Remove `iosX64` and `macosX64` targets. ([#3386](https://github.com/coil-kt/coil/pull/3386))
- **Important**: Increase Android's minimum SDK version to 23. ([#3283](https://github.com/coil-kt/coil/pull/3283))
- **New**: Add fast WebP size extraction on JS/WASM to avoid falling back to a full Skia decode. ([#3341](https://github.com/coil-kt/coil/pull/3341))
- Remove experimental annotation from `ImageLoader.Builder.memoryCacheMaxSizePercentWhileInBackground`. ([#3439](https://github.com/coil-kt/coil/pull/3439))
...
- Look up `ContinuationInterceptor` instead of `CoroutineDispatcher` in coroutine contexts. ([#3415](https://github.com/coil-kt/coil/pull/3415))
