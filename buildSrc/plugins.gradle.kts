rootProject.extra.apply {
    set("androidPlugin", "com.android.tools.build:gradle:7.1.0-beta05")
    set("kotlinPlugin", "org.jetbrains.kotlin:kotlin-gradle-plugin:1.6.10")
    set("dokkaPlugin", "org.jetbrains.dokka:dokka-gradle-plugin:1.6.0")
    set("dokkaAndroidPlugin", "org.jetbrains.dokka:android-documentation-plugin:1.6.0")
