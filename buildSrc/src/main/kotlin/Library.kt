...
object Library {
    ...
    const val ANDROIDX_APPCOMPAT = "androidx.appcompat:appcompat:1.3.0-rc01"
    const val ANDROIDX_APPCOMPAT_RESOURCES = "androidx.appcompat:appcompat-resources:1.3.0-rc01"
