...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        expression = "this.loader().get(GetRequest.Builder().data(uri).apply(builder).build())",
...
): Drawable = loader().get(GetRequest.Builder().data(uri).apply(builder).build())
...
@Deprecated(
    message = "Replace with the GetRequest.Builder API.",
    replaceWith = ReplaceWith(
        expression = "this.loader().get(GetRequest.Builder().data(url).apply(builder).build())",
        imports = ["coil.request.GetRequest"]
    )
)
suspend inline fun Coil.get(
    url: HttpUrl,
    builder: GetRequestBuilder.() -> Unit = {}
): Drawable = loader().get(GetRequest.Builder().data(url).apply(builder).build())
...
@Deprecated(
    message = "Replace with the GetRequest.Builder API.",
    replaceWith = ReplaceWith(
        expression = "this.loader().get(GetRequest.Builder().data(file).apply(builder).build())",
        imports = ["coil.request.GetRequest"]
    )
)
suspend inline fun Coil.get(
    file: File,
    builder: GetRequestBuilder.() -> Unit = {}
): Drawable = loader().get(GetRequest.Builder().data(file).apply(builder).build())
...
@Deprecated(
    message = "Replace with the GetRequest.Builder API.",
    replaceWith = ReplaceWith(
        expression = "this.loader().get(GetRequest.Builder().data(drawableRes).apply(builder).build())",
        imports = ["coil.request.GetRequest"]
    )
)
suspend inline fun Coil.get(
    @DrawableRes drawableRes: Int,
    builder: GetRequestBuilder.() -> Unit = {}
): Drawable = loader().get(GetRequest.Builder().data(drawableRes).apply(builder).build())
...
@Deprecated(
    message = "Replace with the GetRequest.Builder API.",
    replaceWith = ReplaceWith(
        expression = "this.loader().get(GetRequest.Builder().data(drawable).apply(builder).build())",
        imports = ["coil.request.GetRequest"]
    )
)
suspend inline fun Coil.get(
    drawable: Drawable,
    builder: GetRequestBuilder.() -> Unit = {}
): Drawable = loader().get(GetRequest.Builder().data(drawable).apply(builder).build())
...
@Deprecated(
    message = "Replace with the GetRequest.Builder API.",
    replaceWith = ReplaceWith(
        expression = "this.loader().get(GetRequest.Builder().data(bitmap).apply(builder).build())",
        imports = ["coil.request.GetRequest"]
    )
)
suspend inline fun Coil.get(
    bitmap: Bitmap,
    builder: GetRequestBuilder.() -> Unit = {}
): Drawable = loader().get(GetRequest.Builder().data(bitmap).apply(builder).build())
...
@Deprecated(
    message = "Replace with the GetRequest.Builder API.",
    replaceWith = ReplaceWith(
        expression = "this.loader().get(GetRequest.Builder().data(data).apply(builder).build())",
        imports = ["coil.request.GetRequest"]
    )
)
suspend inline fun Coil.getAny(
    data: Any,
    builder: GetRequestBuilder.() -> Unit = {}
): Drawable = loader().get(GetRequest.Builder().data(data).apply(builder).build())
