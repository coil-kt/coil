...
By default, Coil comes packaged with 2 transformations: [circle crop](../api/coil-base/coil-base/coil.transform/-circle-crop-transformation/) and [rounded corners](../api/coil-base/coil-base/coil.transform/-rounded-corners-transformation/).
...
See the [API documentation](../api/coil-base/coil-base/coil.transform/-transformation/) for more information.
